...
export default async function* 做人设<T extends Document>(情节: string, 真名: string, 萌差: string, 补充: string, 提交: (意: string, 证: string) => Promise<void>): AsyncGenerator<人设体 | void, void, void | T> {
