...
import {主持体} from '@/数据/主持'
import {人设体} from '@/数据/人设'
import {encode} from 'base65536'
import {Binary} from 'bson'
import {做人设, 给人设} from './人设'

export async function 做主持(情节: string, 真名: string, 萌差: string, 补充: string, 送出: (意: string, 证: string) => Promise<void>) {
  const gen = 做人设<主持体>(情节, 真名, 萌差, 补充, 送出)
